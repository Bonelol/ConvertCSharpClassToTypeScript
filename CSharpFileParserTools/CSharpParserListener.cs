...
public interface ICSharpParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterLocal_variable_initializer_unsafe([NotNull] CSharpParser.Local_variable_initializer_unsafeContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CSharpParser.local_variable_initializer_unsafe"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitLocal_variable_initializer_unsafe([NotNull] CSharpParser.Local_variable_initializer_unsafeContext context);
	/// <summary>
